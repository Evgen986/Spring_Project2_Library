package ru.malyutin.library.configs;
...
@Configuration
@ComponentScan("ru.malyutin.library")
@EnableWebMvc
@PropertySource("classpath:hibernate.properties")
@EnableTransactionManagement
@EnableJpaRepositories("ru.malyutin.library.repositories")
...
//    }
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory(){
        ...
        em.setPackagesToScan("ru.malyutin.library.model");
